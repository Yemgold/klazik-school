...
/**
 * IndexedDB version of a practice question.
 *
 * The backend does not need to return selectedOption or
 * answered when a session is first created.
 *
 * These fields are maintained locally while the student
 * is learning/practicing.
 */
