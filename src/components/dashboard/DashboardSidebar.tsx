...
// /*
//  * These dashboard areas remain available even when the
//  * student has not selected or activated a plan.
//  *
//  * Everything else in the student navigation is locked.
//  */
...
//    * plans: []
//    *
//    * Access becomes available when the backend confirms
//    * that the student has an active plan.
//    */
